...
test('Our Deck setup shows private batch counts without author identity', () => {
  const snapshot = {
    id: 'hangout-1', thing_id: thing.id, game_type: 'hot', state: 'setup', color_key: 'purple', hot_level: 'spicy', hot_mode: 'our_deck',
...
test('Same Brain renders private answering, reveal and final result states', () => {
  const base = {
    id: 'hangout-2', thing_id: thing.id, game_type: 'same_brain', state: 'active', color_key: 'purple', hot_level: null, hot_mode: null,
